...
if (isset($_POST['button40'])) {
      $exec= "sudo -u svxlink sh -c \"echo '0' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button41'])) {
      $exec= "sudo -u svxlink sh -c \"echo '1' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button42'])) {
      $exec= "sudo -u svxlink sh -c \"echo '2' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button43'])) {
      $exec= "sudo -u svxlink sh -c \"echo '3' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button44'])) {
      $exec= "sudo -u svxlink sh -c \"echo '4' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button45'])) {
     $exec= "sudo -u svxlink sh -c \"echo '5' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button46'])) {
      $exec= "sudo -u svxlink sh -c \"echo '6' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button47'])) {
      $exec= "sudo -u svxlink sh -c \"echo '7' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button48'])) {
     $exec= "sudo -u svxlink sh -c \"echo '8' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button49'])) {
     $exec= "sudo -u svxlink sh -c \"echo '9' > ".$dtmfctrl."\"";
      exec($exec, $output);
}

if (isset($_POST['button50'])) {
     $exec= "sudo -u svxlink sh -c \"echo '*' > ".$dtmfctrl."\"";
      exec($exec, $output);
}
...
if (isset($_POST['buttonAA'])) {
       $exec= "sudo -u svxlink sh -c \"echo 'A' > ".$dtmfctrl."\"";
       exec($exec, $output);
}
if (isset($_POST['buttonBB'])) {
       $exec= "sudo -u svxlink sh -c \"echo 'B' > ".$dtmfctrl."\"";
       exec($exec, $output);
}

if (isset($_POST['buttonCC'])) {
       $exec= "sudo -u svxlink sh -c \"echo 'C' > ".$dtmfctrl."\"";
       exec($exec, $output);
}

if (isset($_POST['buttonDD'])) {
       $exec= "sudo -u svxlink sh -c \"echo 'D' > ".$dtmfctrl."\"";
       exec($exec, $output);
}
