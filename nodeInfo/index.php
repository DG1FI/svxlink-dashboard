...
if (isset($_POST['btnSave'])) {
    ...
    file_put_contents("/var/www/nodeInfo/node_info.json", $jsonNodeInfo, FILE_USE_INCLUDE_PATH);
    ...
    exec('sudo mv /var/www/nodeInfo/node_info.json /etc/svxlink/node_info.json', $screen, $retval);
