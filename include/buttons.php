...
if ($net1 == true || $net2 == true || $net3 == true || $net4 == true || FULLACCESS_OUTSIDE == 1) {
    ...
    if(array_key_exists('button1', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY1[1]."' > ".$dtmfctrl."\"";
			exec($exec, $output);
			echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button2', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY2[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button3', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY3[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button4', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY4[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button5', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY5[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button6', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY6[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button7', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY7[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button8', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY8[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button9', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY9[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button10', $_POST)) {
       $exec= "sudo -u svxlink sh -c \"echo '".KEY10[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button11', $_POST)) {
       $exec= "sudo -u svxlink sh -c \"echo '".KEY11[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button12', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY12[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button13', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY13[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button14', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY14[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button15', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY15[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button16', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY16[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button17', $_POST)) {
       $exec= "sudo -u svxlink sh -c \"echo '".KEY17[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button18', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY18[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button19', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY19[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }
    if(array_key_exists('button20', $_POST)) {
        $exec= "sudo -u svxlink sh -c \"echo '".KEY20[1]."' > ".$dtmfctrl."\"";
            exec($exec, $output);
            echo "<meta http-equiv='refresh' content='0'>";
    }?>
...
<p style="margin-bottom:0px;"></p>
    ...
    if ($dtmfctrl!="/dev/null") {
        ...
        if ($reflector_active) {
            echo "<td style=\"border: none; background-color:#e8e8e8e8;\">";
            echo "<form action=\"\" method=\"POST\" style=\"margin-top:4px;\">";
            echo "<label style=\"text-shadow: 1px 1px 1px Lightgrey, 0 0 0.5em LightGrey, 0 0 1em whitesmoke;font-weight:bold;color:#464646;\" for=\"jmpto\">TG wechseln:<BR></label>";
    ...
    if ((isset($_POST["dtmfsvx"]) == true) && (trim($_POST["dtmfsvx"]) !=='')) {
        $exec= "sudo -u svxlink sh -c \"echo '".$_REQUEST['dtmfsvx']."' > ".$dtmfctrl."\"";
        exec($exec, $output);
        echo "<meta http-equiv='refresh' content='0'>";
    }
    if ((isset($_POST["jmpto"]) == true) && (trim($_POST["jmpto"]) !=='') && (preg_match('/^\d+$/', $_POST["jmpto"]))) {
        $exec= "sudo -u svxlink sh -c \"echo '*91".$_REQUEST['jmpto']."#' > ".$dtmfctrl."\"";
        exec($exec, $output);
        echo "<meta http-equiv='refresh' content='0'>";
    }
    if ((isset($_POST["jmptoA"]) == true) && (trim($_POST["jmptoA"]) !=='') && (preg_match('/^\d+$/', $_POST["jmptoA"]))) {
           $exec= "sudo -u svxlink sh -c \"echo '*91".$_REQUEST['jmptoA']."#' > ".$dtmfctrl."\"";
        exec($exec, $output);
        echo "<meta http-equiv='refresh' content='0'>";
    }
    if ((isset($_POST["addMonTG"]) == true) && (trim($_POST["addMonTG"]) !=='') && (preg_match('/^\d+$/', $_POST["addMonTG"]))) {
           $exec= "sudo -u svxlink sh -c \"echo '*94".$_REQUEST['addMonTG']."#' > ".$dtmfctrl."\"";
        exec($exec, $output);
        echo "<meta http-equiv='refresh' content='0'>";
    }
    ?>
